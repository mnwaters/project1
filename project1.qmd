...
test
defaultTibble <- acsFunction(categoricalVar = c("HHL", "FER"), numericalVar = c("JWAP", "GASP"))
```
...
summary.census(classcensus = test_tibble, numericalVar = c("JWAP"), categoricalVar = ("HHL"))
```
